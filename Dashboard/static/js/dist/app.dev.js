...
!function (s) {
  ...
  function t(e) {
    1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "static/css/bootstrap.min.css"), s("#app-style").attr("href", "static/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "static/css/bootstrap-dark.min.css"), s("#app-style").attr("href", "static/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "static/css/bootstrap.min.css"), s("#app-style").attr("href", "static/css/app-rtl.min.css"), sessionStorage.setItem("is_visited", "rtl-mode-switch"));
  }
